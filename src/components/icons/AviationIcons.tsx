...
export function TowerIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M17 4h-3V2h-4v2H7v18h3v-4h4v4h3V4zm-4 10h-2v-2h2v2zm0-4h-2V8h2v2z"/>
    </svg>
  )
}
...
// 螺旋桨图标
export function PropellerIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
...
// 词汇图标
export function VocabIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
...
// 句子/聊天图标
export function SentenceIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
